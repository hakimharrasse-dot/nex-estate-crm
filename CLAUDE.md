...
| 2026-06-12 | **feat(ux)** : Récap équipe mobile en carrousel — 1 membre à la fois, flèches tactiles centrées + compteur X/N (`renderWkCards` : mobile toujours perPage=1, desktop inchangé ≤5 grille / >5 pagination 4). Demande terrain Hakim (`844ee58`) ← **HEAD** |
