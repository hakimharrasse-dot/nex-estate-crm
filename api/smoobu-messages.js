...
async function generateFullAnalysis(ctx) {
  ...
  const ribLine = companyRib
    ? `\nRIB DE LA SOCIÉTÉ (pour un règlement par VIREMENT) : ${companyRib}\n⚠️ Ne communique ce RIB au voyageur QUE si : (a) c'est un client BOOKING ou DIRECT qui choisit / demande le virement, OU (b) une consigne de Hakim te demande de donner le RIB. Ne le donne JAMAIS à un client Airbnb, ni spontanément, ni s'il paie autrement (espèces / Western Union).\n`
    : '';
